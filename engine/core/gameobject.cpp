...
//template<>
//QList<Updatable*> GameObject::getComponents()
//{
//    QList<Updatable*> comps;
//    for(Component* comp : components()) {
//        Updatable* ptr = nullptr;
//        ptr = dynamic_cast<Updatable*>(comp);
//        if(ptr!=nullptr) {
//            comps.append(ptr);
//        }
//    }
...
//template<>
//QList<Renderer*> GameObject::getComponents()
//{
//    QList<Renderer*> comps;
//    for(Component* comp:components()) {
//        Renderer* ptr = nullptr;
//        ptr = dynamic_cast<Renderer*>(comp);
//        if(ptr!=nullptr)
//            comps.append(ptr);
//    }
//    return comps;
...
//template<>
//QList<Camera*> GameObject::getComponents();
